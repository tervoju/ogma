...
double inverseSensorModel(
    double x,           // robot pose x
    double y,           // robot pose y
    double theta,       // robot pose
    double xi,          // center of a mass for cell x
    double yi,          // center of a mass for cell y
    double sensorData[] // measurement data
    )
{
...
int main()
{
    ...
    printf("ogma loop starting \n");
    if (posesFile == NULL || measurementFile == NULL)
    {
    ...
    while (fscanf(posesFile, "%lf %lf %lf %lf", &timeStamp, &robotX, &robotY, &robotTheta) != EOF)
    {
        ...
        // pose is x,y,theta (theta x.x degrees -> transformed to rad)
